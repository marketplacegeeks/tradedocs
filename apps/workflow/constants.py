...
PLCI_TRANSITIONS = {
    DRAFT: {
        SUBMIT: (PENDING_APPROVAL, [UserRole.MAKER, UserRole.COMPANY_ADMIN, UserRole.SUPER_ADMIN]),
        PERMANENTLY_REJECT: (PERMANENTLY_REJECTED, [UserRole.CHECKER, UserRole.COMPANY_ADMIN, UserRole.SUPER_ADMIN]),
    },
    PENDING_APPROVAL: {
        APPROVE: (APPROVED, [UserRole.CHECKER, UserRole.COMPANY_ADMIN, UserRole.SUPER_ADMIN]),
        REWORK_ACTION: (REWORK, [UserRole.CHECKER, UserRole.COMPANY_ADMIN, UserRole.SUPER_ADMIN]),
        PERMANENTLY_REJECT: (PERMANENTLY_REJECTED, [UserRole.CHECKER, UserRole.COMPANY_ADMIN, UserRole.SUPER_ADMIN]),
    },
    REWORK: {
        SUBMIT: (PENDING_APPROVAL, [UserRole.MAKER, UserRole.COMPANY_ADMIN, UserRole.SUPER_ADMIN]),
