...
class CommercialInvoiceLineItemSerializer(serializers.ModelSerializer):
    ...
    def validate_rate(self, value):
        ...
        # Reject more than 4 decimal places
        if value.as_tuple().exponent < -4:
            raise serializers.ValidationError("Rate can have at most 4 decimal places.")
        return value
...
class CommercialInvoiceSerializer(serializers.ModelSerializer):
    ...
    def get_bank_details(self, obj):
        ...
        return {
            ...
            "iban": b.iban,
            "ad_code": b.ad_code,
            "lut_number": b.lut_number,
            "lut_valid_until": b.lut_valid_until.isoformat() if b.lut_valid_until else None,
            "is_lut_expired": b.is_lut_expired,
